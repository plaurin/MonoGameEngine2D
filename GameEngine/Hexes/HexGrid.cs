namespace WindowsGame1.Hexes
{
    ...
    public class HexGrid
    {
        ...
        {
            var temp = new HexGridElement(Vector2.Zero, edgeLength);
        ...
        public static IEnumerable<HexGridElement> CreateHexMap(Vector2 startingCenter, float edgeLength, Rectangle areaRectangle)
        {
